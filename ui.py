...
class RENDER_PT_network_job(NetRenderButtonsPanel, bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(netsettings, "job_output_file_ext", text="Output File Ext")
...
class NetRenderSettings(bpy.types.PropertyGroup):
    ...
    def register(NetRenderSettings):
        ...
        NetRenderSettings.job_output_file_ext = StringProperty(
                        name="Output file ext",
                        description="Output file extension, must be as output file format settings: PNG - png ...",
                        maxlen = 256,
                        default = "exr")
